...
document.addEventListener('DOMContentLoaded', function () {
  var showFiltersBtn = document.querySelector("#js-dog-archive-filter-button");
  var filterFormWrapper = document.querySelector("#js-filtering-form-wrapper");
  var filterForm = document.querySelector('#dog-archvive-filter-form');
  showFiltersBtn.addEventListener('click', function (event) {
    event.preventDefault();
    filterFormWrapper.classList.toggle('hidden');
  });
  filterFormWrapper.addEventListener('click', function (event) {
...
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper */ "./src/javascript/swiper.js");
/* harmony import */ var _dog_archive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dog-archive */ "./src/javascript/dog-archive.js");
/* harmony import */ var _dog_archive__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_dog_archive__WEBPACK_IMPORTED_MODULE_1__);


document.addEventListener('DOMContentLoaded', function () {
  var BODY = document.querySelector('body');
  var MOBILE_MENU_TOGGLE = document.querySelector('#js-navigation__mobile-menu-toggle');
  var MOBILE_MENU = document.querySelector('#js-mobile-menu');
  var SEARCH_TOGGLE = document.querySelector('#js-search-bar-toggle');
  /**
   * Toggle mobile menu on hamburger icon click.
   */

  MOBILE_MENU_TOGGLE.addEventListener('click', function (event) {
    event.preventDefault();
...
document.addEventListener('DOMContentLoaded', function () {
  var swiper1234Instances = document.querySelectorAll('.swiper-1234');
  swiper1234Instances.forEach(function (element) {
  ...
  var swiper1223Instances = document.querySelectorAll('.swiper-1223');
  swiper1223Instances.forEach(function (element) {
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](element, {
      direction: 'horizontal',
      loop: false,
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkravnostitcuprija"] = self["webpackChunkravnostitcuprija"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/editor-styles","css/main"], () => (__webpack_require__("./src/javascript/main.js")))
/******/ 	__webpack_require__.O(undefined, ["css/editor-styles","css/main"], () => (__webpack_require__("./src/sass/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/editor-styles","css/main"], () => (__webpack_require__("./src/sass/editor-styles.scss")))
